...
vector<ZZ> RC_4::Generar_Aleatorio(int numero_bits){
    vector<ZZ> total;/*
    ...
    RandomBits(testerino,numero_bits);
    total.push_back(testerino);
    return total;
}
vector<ZZ> RC_4::Numero_Grande(){
    vector<ZZ> numero,temp,temp1;
    cout<<endl;
